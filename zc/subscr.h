...
void frame2x2(BITMAP *dest, miscQdata *misc, int x, int y, int tile, int cset, int w, int h, int flip, bool overlay,
              bool trans);
void drawgrid(BITMAP *dest, int x, int y, int c1, int c2);
void draw_block(BITMAP *dest, int x, int y, int tile, int cset, int w, int h);
void drawdmap(BITMAP *dest, miscQdata *misc, int x, int y, bool showmap, int showlink, int showcompass, int linkcolor,
              int lccolor, int dccolor);
...
void putxnum(BITMAP *dest, int x, int y, int num, FONT *tempfont, int color, int shadowcolor, int bgcolor,
             int textstyle, bool usex, int digits, bool infinite, char idigit);
void defaultcounters(BITMAP *dest, int x, int y, FONT *tempfont, int color, int shadowcolor, int bgcolor, bool usex,
                     int textstyle, int digits, char idigit);
void counter(BITMAP *dest, int x, int y, FONT *tempfont, int color, int shadowcolor, int bgcolor, int alignment,
             int textstyle, int digits, char idigit, bool showzero, int itemtype1, int itemtype2, int itemtype3, int infiniteitem,
             bool onlyselected);
void minimaptitle(BITMAP *dest, int x, int y, FONT *tempfont, int color, int shadowcolor, int bgcolor, int alignment,
                  int textstyle);
...
void puttriframe(BITMAP *dest, miscQdata *misc, int x, int y, int triframecolor, int numbercolor, int triframetile,
                 int triframecset, int triforcetile, int triforcecset, bool showframe, bool showpieces, bool largepieces);
void puttriforce(BITMAP *dest, miscQdata *misc, int x, int y, int tile, int cset, int w, int h, int flip, bool overlay,
                 bool trans, int trinum);
void draw_block(BITMAP *dest, int x, int y, int tile, int cset, int w, int h);
void draw_block_flip(BITMAP *dest, int x, int y, int tile, int cset, int w, int h, int flip, bool overlay, bool trans);
void putBmap(BITMAP *dest, miscQdata *misc, int x, int y, bool showmap, bool showrooms, bool showlink, int roomcolor,
             int linkcolor, bool large);
void load_Sitems(miscQdata *misc);
void textout_styled_aligned_ex(BITMAP *bmp, const FONT *f, const char *s, int x, int y, int textstyle, int alignment,
                               int color, int shadow, int bg);
void textprintf_styled_aligned_ex(BITMAP *bmp, const FONT *f, int x, int y, int textstyle, int alignment, int color,
                                  int shadow, int bg, const char *format, ...);
